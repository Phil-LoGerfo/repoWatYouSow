...
# A bunch of variables that are initialized before the operation
...
pdata <- data.frame(row.names = pnames, Total_Volume = totala, Total_Voids = totalv, Total_Mean = tavg,
                    Primary_Voids = primv, Primary_Mean = primavg, 
                    Micro_Voids = micv, Micro_Mean = microavg) 


write.table(pdata, "pVolsData.csv", sep = ",", row.names = TRUE)
